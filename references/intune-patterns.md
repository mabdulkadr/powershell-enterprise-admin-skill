...
8. [Remote Diagnostics Collection](#remote-diagnostics-collection)
9. [Microsoft Graph API Integration](#microsoft-graph-api-integration)
- [Authentication](#authentication)
    - [WAM-Free Interactive Sign-In (MgGraphCommunity)](#wam-free-interactive-sign-in-mggraphcommunity)
    - [Multi-Method Auth Dialog (GUI Tools)](#multi-method-auth-dialog-gui-tools)
    - [Azure Automation Portal-Safe Parameters](#azure-automation-portal-safe-parameters)
    - [Azure Automation Job Metadata](#azure-automation-job-metadata)
    - [Pagination Helper (Handles Throttling)](#pagination-helper-handles-throttling)
    - [Graph API Retry with Exponential Backoff](#graph-api-retry-with-exponential-backoff)
    - [Graph Batch API (Bulk Operations)](#graph-batch-api-bulk-operations)
    - [403 Handling: Missing Roles and Multi-Admin Approval](#403-handling-missing-roles-and-multi-admin-approval)
    - [Common Graph Operations](#common-graph-operations)
    - [Dry-Run Pattern](#dry-run-pattern)
10. [Logging and Output](#logging-and-output)
